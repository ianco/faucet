...
# mysql -u root -p -e "create database graphene_prod"
# mysql -u root -p -e "create database bitshares_faucet_dev"
# mysql -u root -p -e "create database bitshares_faucet_test"
# mysql -u root -p -e "create database bitshares_faucet"

export USER_NAME="osboxes"
...
sudo chown -R osboxes:users /www
